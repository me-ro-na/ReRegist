                    ...
                    <div class="pop_swipe_scroll">
                        <div class="tip_box">
                            <ul class="tip_txt_list">
                                <li><span>영상길이 제한이 있나요</span></li>
                                <li><span>시스템 권한 신청 도와주세요</span></li>
                                <li><span>확인서가 승인되는 절차가 궁금해요</span></li>
                                <li><span>회원단체 등록하는데 재등록이 뭐야</span></li>
                                <li><span>비승인 정보 초기화하기</span></li>
                            </ul>
                        </div>
